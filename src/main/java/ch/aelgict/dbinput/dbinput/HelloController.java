...
public class HelloController {
    ...
    void handleButtonNext(ActionEvent event) {
        ...
        System.out.println(databaseConnection.createConnection(txtHost.getText(), Integer.valueOf(txtPort.getText()),txtUsername.getText(), txtPassword.getText(), txtDBName.getText(), txtTable.getText()));
